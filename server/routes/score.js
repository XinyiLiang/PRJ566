...
//get all scores
router.get('/get/getAllScores', (req, res, next ) => {
  ...
  //get ONE SCORE   
router.get('/get/score', (req, res, next) => {
...
router.get('/get/scoreTeam', (req, res, next) => {
  ...
  // router.get('/get/scoreTeam', async (req, res) => {
  ...
  router.post('/get/scoreTeam/:id', async (req, res) => {
  ...
  router.post('/score/posttodb', (req, res, next) => {
  ...
  //edit current score
  router.put('/put/score', (req, res, next) => {
  ...
  //edit current score
  router.put(`/put/addStep/:team_id`, (req, res, next) => {
    const values = [ req.body.team_id,
                     req.body.game_id];
...
//zero steps
  router.put(`/put/zeroStep/:team_id`, (req, res, next) => {
    const values = [ req.body.team_id,
                     req.body.game_id];
  ...
  router.delete('/delete/score', (req, res, next) => {
