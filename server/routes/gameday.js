...
router.get('/get/getAllGamedays', async (req, res) => {
  ...
  //get one gameday
router.get('/get/gameday', (req, res, next) => {
  ...
  router.post('/gameday/posttodb', (req, res, next) => {
  ...
  //edit current GAME
  router.put('/put/gameday', (req, res, next) => {
  ...
  router.delete('/delete/gameday', (req, res, next) => {
