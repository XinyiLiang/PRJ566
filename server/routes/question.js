...
//get all the questions for particular scenario
  router.get('/get/getAllQuestionsby/:id', async (req, res) => {
  ...
  //get one question
router.get('/get/question/:id', (req, res, next) => {
  ...
  router.post('/question/posttodb', (req, res, next) => {
  ...
  router.put('/put/question', (req, res, next) => {
